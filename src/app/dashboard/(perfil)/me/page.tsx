...
import CreateIncidentDialog from "@/app/dashboard/(modulos)/incidents/_components/CreateIncidentDialog";
import IncidentDetailSheet from "@/app/dashboard/(modulos)/incidents/_components/IncidentDetailSheet";
import type { CreateIncidentInput, IncidentDetail } from "@/app/dashboard/(modulos)/incidents/_lib/types";
import { apiCreateIncident, apiGetIncidentDetail } from "@/app/dashboard/(modulos)/incidents/_lib/api";
