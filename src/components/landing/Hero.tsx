    ...
    >
      ...
      <div className="relative z-10 h-full">
        <div className="mx-auto w-full max-w-7xl px-5 sm:px-6 lg:px-10">
          {/* Este wrapper es el que hace que el contenido quede centrado al crecer */}
          <div className="sm:flex sm:min-h-[calc(88vh-88px)] sm:items-center">
            <motion.div
            ...
            >
              {/* BRAND */}
              <motion.h1
                className="mt-3 font-extrabold leading-[1.03] tracking-tight text-white drop-shadow-sm"
                variants={{
              ...
              >
                Acompañamos a tu empresa con soluciones confiables, eficientes y
                personalizadas, impulsando el crecimiento y la continuidad de tus
                operaciones.
              </motion.p>
